  ...
  "Statement": [
    ...
    },
    {
      ...
      "Resource": [
        ...
        "arn:aws:dynamodb::ACCOUNT_ID:global-table/efcms-joe",
        ...
        "arn:aws:dynamodb:us-east-1:ACCOUNT_ID:table/efcms-joe",
        ...
        "arn:aws:dynamodb:us-west-1:ACCOUNT_ID:table/efcms-joe"
      ]
    },
    {
      "Sid": "IamGranular",
